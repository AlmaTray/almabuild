...
/datum/loadout_manager/ui_static_data()
	...
	loadout_tabs += list(list("name" = "Пояс", "title" = "Предметы в слот пояса", "contents" = list_to_data(GLOB.loadout_belts)))
	loadout_tabs += list(list("name" = "Уши", "title" = "Предметы в слот ушей", "contents" = list_to_data(GLOB.loadout_ears)))
	loadout_tabs += list(list("name" = "Глаза", "title" = "Предметы в слот глаз", "contents" = list_to_data(GLOB.loadout_glasses)))
	loadout_tabs += list(list("name" = "Руки", "title" = "Предметы в слот рук", "contents" = list_to_data(GLOB.loadout_gloves)))
	loadout_tabs += list(list("name" = "Голова", "title" = "Предметы в слот головы", "contents" = list_to_data(GLOB.loadout_helmets)))
	loadout_tabs += list(list("name" = "Маска", "title" = "Предметы в слот маски", "contents" = list_to_data(GLOB.loadout_masks)))
	...
	loadout_tabs += list(list("name" = "В руках", "title" = "Предметы, появляющиеся в руках", "contents" = list_to_data(GLOB.loadout_inhand_items)))
	loadout_tabs += list(list("name" = "Игрушки", "title" = "Игрушки! (Не больше [MAX_ALLOWED_MISC_ITEMS])", "contents" = list_to_data(GLOB.loadout_toys)))
	loadout_tabs += list(list("name" = "Разное", "title" = "Предметы, появляющиеся в рюкзаке (Не больше [MAX_ALLOWED_MISC_ITEMS])", "contents" = list_to_data(GLOB.loadout_pocket_items)))
